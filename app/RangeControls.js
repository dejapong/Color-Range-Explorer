...
RangeControls.prototype._onMouseMove = function (e) {
  ...
  if (e.target == this.canvas) {
    if (e.offsetY > this.height - this.scale.height) {
      redraw = this.scale.handleMouseOver(e) || this.colorBar.handleMouseOut(e);
    } else {
      redraw = this.colorBar.handleMouseOver(e) || this.scale.handleMouseOut(e);
    }
  } else {
    redraw = this.colorBar.handleMouseOut(e) || this.scale.handleMouseOut(e);
  }
...
RangeControls.prototype.evaluate = function (value) {
  return this.map.evaluate(Math.max(this.scale.min, Math.min(this.scale.max, value)));
};
